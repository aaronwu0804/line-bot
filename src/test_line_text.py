...
這個腳本僅測試 LINE 訊息發送功能，不包含圖片下載部分，
用來確認 LINE Channel Access Token 是否有效。
"""
...
def test_line_message():
    ...
    try:
        ...
        message = TextMessage(text=f"LINE Bot 測試 - {current_time}")
        ...
        logger.info("訊息發送成功！Access Token 有效")
        return True
...
if __name__ == "__main__":
    if test_line_message():
        print("\n✓ LINE 訊息測試成功！Access Token 有效")
    else:
        print("\n✗ LINE 訊息測試失敗！請檢查 Access Token")
