...
{{
  ...
  "confidence": 0.0-1.0
    ...
    def _classify_with_rules(self, message: str) -> Dict:
        ...
        # 支援自然語言：完成了、取消了、不用了、不做了等
        todo_update_keywords = ['完成了', '做完了', '已經做完', '取消了', '不用了', '不做了', '刪掉', '移除', '取消待辦', '刪除待辦', '完成待辦', '已完成', '標記完成', '完成任務', '已經完成']
        # 擴充創建關鍵字：提醒（不只提醒我）、新增、新增事項等
        todo_create_keywords = ['提醒我', '提醒', '我要', '我明天要', '我今天要', '新增待辦', '新增事項', '新增任務', '新增', '幫我記', '記得', '別忘了', '添加任務', '添加事項', '加入待辦']
